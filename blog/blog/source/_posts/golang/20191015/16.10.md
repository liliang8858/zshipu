...
依附于[第13章](file://13.0.md)模式的描述和[第17.1小节](file://17.1.md)与[第17.2.4小节](file://17.2.md)的总结。
...
这种方法可以很容易分辨出错误检测、错误通知和正常的程序逻辑（更详细的方式参考[第13.5小节](file://13.5.md)）。

**在开始阅读[第17章](file://17.0.md)前，先回答下列2个问题：**
...
- 上一节：[闭包和协程的使用](file://16.9.md)
- 下一章：[Go 语言模式](file://17.0.md)
