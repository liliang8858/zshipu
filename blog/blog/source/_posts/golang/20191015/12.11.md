...
Gob 通常用于远程方法调用（RPCs，参见 [15.9节](file://15.9.md) 的 rpc 包）参数和结果的传输，以及应用程序和机器之间的数据传输。
...
- 上一节：[XML 数据格式](file://12.10.md)
- 下一节：[Go 中的密码学](file://12.12.md)
