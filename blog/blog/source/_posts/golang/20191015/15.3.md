...
我们会在 [15.4节](file://15.4.md) 中用到 `http` 包中的其他重要的函数：
...
练习 15.4：扩展 http_fetch.go 使之可以从控制台读取url，使用 [12.1节](file://12.1.md) 学到的接收控制台输入的方法（[http_fetch2.go](examples/chapter_15/http_fetch2.go)）
...
- 上一节：[一个简单的网页服务器](file://15.2.md)
- 下一节：[写一个简单的网页应用](file://15.4.md)
