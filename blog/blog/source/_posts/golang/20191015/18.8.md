---
title: go入门教程- 18.8 协程（goroutine）与通道（channel）   
...
（6）如何限制并发处理请求的数量：参考[章节14.11](file://14.11.md)

（7）如何在多核CPU上实现并行计算：参考[章节14.13](file://14.13.md)
...
（11）如何在同步调用运行时间过长时将之丢弃：参考[章节14.5](file://14.5.md) 第二个变体

（12）如何在通道中使用计时器和定时器：参考[章节14.5](file://14.5.md)

（13）典型的服务器后端模型：参考[章节14.4](file://14.4.md)

## 链接

- [目录](https://blog.zshipu.com/go%E5%85%A5%E9%97%A8%E6%95%99%E7%A8%8B/index.html)
- 上一节：[文件](file://18.7.md)
- 下一节：[网络和网页应用](file://18.9.md)