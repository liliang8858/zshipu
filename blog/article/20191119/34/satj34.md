...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/playerdemo.png' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/color.png' style="max-width:80%; max-height=80%;"></img></p>

4、[Modlishka](https://github.com/drk1wi/Modlishka)：钓鱼网站生成工具。该工具会根据给定的模版生成一个钓鱼网站，然后在该网站输入的用户名密码等敏感信息会被记录

<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/Modlishka.jpeg' style="max-width:80%; max-height=80%;"></img></p>

5、[txqr](https://github.com/divan/txqr)：通过动态二维码传输数据，如：传输文件等

<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/txqr.gif' style="max-width:80%; max-height=80%;"></img></p>

6、[gitbatch](https://github.com/isacikgoz/gitbatch)：批量管理 Git 仓库的命令行工具

<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/gitbatch.gif' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/android-viabus-architecture.png' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/vConsole.png' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/hve-notes.png' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/weapp-library.png' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/axial3d.gif' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/giojs.gif' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/keycastr.gif' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/laravel-s.png' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/sherlock.png' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/PSpider.png' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/the-gan-zoo.png' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center"><img src='https://sblig.gitee.io/static/satj/34/img/Semantic-Segmentation-Suite.gif' style="max-width:80%; max-height=80%;"></img></p>
...
<p align="center">
    <a href="../../33/satj33">『上一期』</a>  | <a href="../../35/satj35">『下一期』</a>
</p>
