...
title: Gulp 入门指南 -使用 gulp 压缩 CSS
author: 知识铺
weight: -1
---
...
当熟悉 [使用 gulp 压缩 JS](https://blog.zshipu.com/article/post/gulp/20191111/chapter2/) 的方法后，配置压缩 CSS 的 gulp 代码就变得很轻松。
...
**二、参照 [使用 gulp 压缩 JS](https://blog.zshipu.com/article/post/gulp/20191111/chapter2/) 创建 `gulpfile.js` 文件编写代码**
